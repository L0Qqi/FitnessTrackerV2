...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Training.Duration.Hours() * MinInHours)
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(speedInMS, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Training.Duration.Hours() * MinInHours)
}
